...
exports.default = async (version) => {
    ...
    console.log(chalk_1.default.bold.red(" For errors relating to nocli-handler.js, please read https://github.com/tribui141108/nocli-handler.js/blob/master/docs/Errors.md"));
